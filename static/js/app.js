...
//Initial function that fills the dropdown menu and calls
//other function (optionChanged) for filling the page with first ID subject`s information
function init() {
        d3.json("samples.json").then((data) => {
                ...
                //Calling function that fills information and passing data to plot-building functions
                optionChanged("940");
